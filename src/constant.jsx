...
export const my_projects = [
  {
    ...
    points: [
      ...
      "Built features to manage merchants — including creation, approval, rejection, and detailed merchant views.",
      "Developed modules for user role management, transaction monitoring, and bank assignment to merchants.",
    ],
  },
  {
    title: "Web Plugin",
    ...
    points: [
      ...
      "Integrated multiple payment methods for enhanced user flexibility and convenience.",
      "Added real-time status updates, improving transparency and increasing transaction success rates by 10%.",
    ],
  },
  {
    ...
    points: [
      ...
      "Integrated Cashbook module into MIS by embedding it via iframe for seamless access and data visibility.",
    ],
  },
  {
    ...
    points: [
      ...
      "Implemented role-based access control for secure and personalized user experiences.",
      "Enabled residents to track complaint and task progress, enhancing transparency.",
      "Added features for supervisors to manage locations, CTPTs, and monitor waste processing.",
      "Improved performance by optimizing React rendering and lazy loading.",
    ],
  },
  {
    ...
    points: [
      ...
      "Built full CRUD operations for managing expenses efficiently.",
      "Integrated pagination to handle large datasets with smooth navigation.",
      "Designed with a focus on clean UI, responsiveness, and real-world usability.",
      "Deployed application on Vercel with CI/CD pipeline using GitHub Actions.",
    ],
  },
  {
    title: "Citizen App",
    ...
    points: [
      ...
      "Implemented real-time updates and data management using Firebase queries for seamless performance.",
      "Focused on creating a user-friendly and transparent platform for better citizen service access.",
    ],
  },
];
